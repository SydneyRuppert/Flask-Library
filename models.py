...
class Book(db.Model):
    ...
    def __init__(self,authors_first_name,authors_last_name,book_title,genre,pages,user_token, id = ''):
        self.id = self.set_id()
...
class ContactSchema(ma.Schema):
    class Meta:
        fields = ['id', 'name','authors_last_name','authors_first_name','book_title', 'genre','pages']
